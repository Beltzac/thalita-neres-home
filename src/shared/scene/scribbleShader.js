...
export function initScribbleShader({ container, strokeCount = 60, canvasClass = 'scribbleLayer' }) {
  ...
  function draw() {
    ...
    gl.uniform1f(uThicknessScale, 0.7);
